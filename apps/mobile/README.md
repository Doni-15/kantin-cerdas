...
Template konfigurasi tersedia di [`.env.example`](../../.env.example). Fondasi
`v0.1.0-alpha.2` belum membaca environment variable apa pun dan file `.env`
asli tidak boleh masuk Git.
